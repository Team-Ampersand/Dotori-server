...
public class DeveloperSelfStudyController {
    ...
    public SingleResult getSelfStudyStudentsByCreateDateDeveloper() {
    ...
    public SingleResult<Map<String, String>> selfStudyTotalCountDeveloper() {
    ...
    public CommonResult banSelfStudyDeveloper(@PathVariable("id") Long id) {
    ...
    public CommonResult banCancelSelfStudyDeveloper(@PathVariable("id") Long id) {
