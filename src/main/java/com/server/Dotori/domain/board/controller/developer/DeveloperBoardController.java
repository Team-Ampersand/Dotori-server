package com.server.Dotori.domain.board.controller.developer;
...
public class DeveloperBoardController {
    ...
    public SingleResult<Page<BoardGetDto>> getAllBoardDeveloper(@PageableDefault(size = 6) Pageable pageable) {
