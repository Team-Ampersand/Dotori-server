package com.server.Dotori.domain.board.controller.councillor;
...
public class CouncillorBoardController {
    ...
    public SingleResult<Page<BoardGetDto>> getAllBoardCouncillor(@PageableDefault(size = 6) Pageable pageable) {
    ...
    public CommonResult updateBoardCouncillor(@Valid @PathVariable("id") Long boardId, @Valid @RequestBody BoardDto boardUpdateDto) {
