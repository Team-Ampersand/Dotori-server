package com.server.Dotori.domain.schedule.self_study;
...
class SelfStudyScheduleTest {
    ...
    public void weekdaySelfStudyStatusReset() {
        ...
        long count = scheduledTasks.stream()
                ...
                .filter(cronTask -> cronTask.getExpression().equals("0 0 2 ? * MON-FRI") && cronTask.toString().equals("com.server.Dotori.model.member.schedule.SelfStudySchedule.weekdaySelfStudyStatusReset"))
                .count();
